...
/* zasuk nazaj (!!!) na nicelni azimut	  ออออออออออออออออออออออออออ*/
...
/*------------------------------------------------------------------*/
/* V4.0 dodan string za ROC417, array zaklju่en z NULL in ustrezno	*/
/* modificiran case RIGHT											*/
/*																	*/
/*------------------------------------------------------------------*/
int		ShowEncoder(void *vp)
{
	char	c[64],*s[]={"ROC415","ROC415G"," --- ","ROC417",NULL};
	double	p,r,e;
