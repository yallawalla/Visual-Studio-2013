...
int	Utm_alpha(void)
{
	strncpy(error_screen[0],&LcdBuffer[0],20);
	strncpy(error_screen[1],&LcdBuffer[20],20);
	strncpy(error_screen[2],&LcdBuffer[40],20);
	strncpy(error_screen[3],&LcdBuffer[60],20);
	strncpy(&error_screen[0][12],&LcdExt[0],8);
	strncpy(&error_screen[1][12],&LcdExt[8],8);
	strncpy(&error_screen[2][12],&LcdExt[16],8);
	strncpy(&error_screen[3][12],&LcdExt[24],8);
	screen_swap(SWAP_T);
	return(null);
}
/*-----------------------------------------------------------------*/
