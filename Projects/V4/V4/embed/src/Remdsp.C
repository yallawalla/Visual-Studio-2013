...
/*
	SetTask(stattest,0,RTC_task);			echo na pc								
	SetTask(stattime,1,PIT_task);
*/
...
/*  prebere blok iz dsp */
/* testiranje
unsigned	int t=0,ti=0,to=0,cs[128],ct[128];
