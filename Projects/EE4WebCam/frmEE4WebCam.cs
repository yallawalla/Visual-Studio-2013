...
namespace EE4Test
{
    public partial class frmEE4WebCam : Form
    {
        ...
        private void Broadcast_Click(object sender, EventArgs e)
        {
            ...
            _deviceSource = _job.AddDeviceSource(video, audio);
            _deviceSource.PickBestVideoFormat(new Size(640, 480),30);
            _job.OutputFormat.VideoProfile.Size = new Size(640, 480);
            _job.OutputFormat.VideoProfile.FrameRate = 12;
            _job.ActivateSource(_deviceSource);         
